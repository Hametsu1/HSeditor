...
namespace HSeditor.Windows
{
    ...
    public partial class ItemTooltip : UserControl
    {
        public ItemTooltip(Item item)
        {
            ...
            item2.BindingProp2 = !item.Rarity.ShowInTooltip ? item.Slot.UniqueName : item.Rarity == null ? "Unknown Rarity" : item.Rarity.Name + " " + (item.Slot.ID == 3 ? item.WeaponType.Name : item.Slot.UniqueName);
